...
namespace DarkLight.Infrastructure.Scheduler
{
    public class PriorityTaskScheduler : TaskScheduler
    {
        ...
        public PriorityTaskScheduler()
        {
            ...
            _tsp = 50;// Convert.ToInt32(ConfigurationManager.AppSettings["TASK_SCHEDULER_PERIOD"]);
            _buferSize = 4096;//Convert.ToInt32(ConfigurationManager.AppSettings["BUFFER_SIZE"]);
            _threshold = 3000.0; // Convert.ToDouble(ConfigurationManager.AppSettings["SUSPENSION_THRESHOLD"]);
